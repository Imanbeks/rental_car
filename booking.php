    ...
    ?>
       ...
       <div class="hai">
            <div class="navbar">
                ...
                <div class="menu" >
                    <ul>
                        <li ><a href="cardetails.php">ГЛАВНАЯ</a></li>
                        <li><a href="aboutus2.html">О НАС</a></li>
                        <li><a href="#">ДИЗАЙН</a></li>
                        <li><a href="contactus2.html">КОНТАКТЫ</a></li>
                        <li><button class="nn"><a href="index.html">ВЫЙТИ</a></button></li>
                        <li><img src="images/profile.png" class="circle" alt="Alps"></li>
                    <li><p class="phello">ПРИВЕТ! &nbsp;<a id="pname"><?php echo $rows['FNAME']." ".$rows['LNAME']?></a></p></li>
        ...
        <form id="register" method="POST"  >
            <h2>НАЗВАНИЕ АВТО : <?php echo "".$email['CAR_NAME']?></h2>
            <label>МЕСТО БРОНИРОВАНИЯ : </label>
            <br>
            <input type="text" name="place"
            id="name" placeholder="Введите Место Бронирования">
            <br><br>

            <label>ДАТА БРОНИРОВАНИЯ : </label>
            <br>
            <input type ="date" name="date"
            id="datefield" min='1899-01-01' max='2000-13-13'  placeholder="ВВЕДИТЕ ДАТУ БРОНИРОВАНИЯ">
            <br><br>

            <label>ДЛИТЕЛЬНОСТЬ : </label>
            <br>
            <input type ="number" name="dur" min="1" max="30" 
            id="name" placeholder="Введите длительность аренды(дней)">
            <br><br>

            <label>НОМЕР ТЕЛЕФОНА : </label>
            <br>
            <input type="tel" name="ph" maxlength="10"
            id="name" placeholder="Введите Номер Вашего Телефона">
            <br><br>
            
            <label>НАЗНАЧЕНИЕ : </label>
            <br>
            <input type="text" name="des"
            id="name" placeholder="Введите Ваше Назначение">
            <br><br>

            <label>Дата возврата : </label>
            <br>
            <input type ="date" name="rdate"
            id="dfield"  min='1899-01-01' placeholder="Введите Дату возврата">
            <br><br>
            <input type="submit"  class="btnn" value="АРЕНДОВАТЬ" name="book" >

        ...
        <div class="navbar">
            ...
            <div class="menu">
                ...
                <ul>
                    ...
                    <li><a href="feedback/Feedbacks.php">ОТЗЫВЫ</a></li>
                    ...
                    <li><a id="stat" href="bookinstatus.php">СТАТУС АРЕНДЫ</a></li>
                </ul>
            </div>
            
            
        </div>
      <div><h1 class="overview">Обзор Наших Авто</h1>
    ...
    <div class="box">
       <div class="imgBx">
        ...
        <div class="content">
            ...
            <h2>Тип Топлива : <a><?php echo $result['FUEL_TYPE']?></a> </h2>
            <h2>Вместимость : <a><?php echo $result['CAPACITY']?></a> </h2>
            <h2>Цена За День : <a>⃀<?php echo $result['PRICE']?>/-</a></h2>
            <button type="submit"  name="booknow" class="utton" style="margin-top: 5px;"><a href="booking.php?id=<?php echo $res;?>">выбрать</a></button>
        </div>
    </div></form></li>
    <?php
        }

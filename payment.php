...
?>
  ...
  <h2 class="payment">ОБЩАЯ СУММА ПЛАТЕЖА : <a>₹<?php echo $email['PRICE']?>/-</a></h2>

    <div class="card">
      <form method="POST">
        <h1 class="card__title">Введите Данные Для Оплаты</h1>
        <div class="card__row">
          <div class="card__col">
            <label for="cardNumber" class="card__label">Номер Карты</label
            ><input
              type="text"
        ...
        <div class="card__row">
          <div class="card__col">
            <label for="cardExpiry" class="card__label">СРОК ДЕЙСТВИЯ</label
            ><input
              type="text"
              class="card__input"
              id="cardExpiry"
        ...
        <button class="btn"><a href="cancelbooking.php">ОТМЕНА</a></button>
        <script>
